...
namespace AdvancedProgramming_Lesson1.Controllers
{
    public class ShoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Size,Price,Weight,LiftLength,Material")] Shoe shoe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Size,Price,Weight,LiftLength,Material")] Shoe shoe)
        {
            if (id != shoe.Id)
            {
                return NotFound();
